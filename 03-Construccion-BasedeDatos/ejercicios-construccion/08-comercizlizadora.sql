...
numero_fb CHAR(5) NOT NULL,
descripcion VARCHAR(50) NOT NULL,
precio_unitario DECIMAL (10,2) NOT NULL,
existencia INT NOT NULL,
CONSTRAINT pk_producto
PRIMARY KEY (numero_producto, numero_fb),
CONSTRAINT uq_producto_descripcio
UNIQUE (descripcion),
...
/*==================se agrego el constraint unique para el campo cuidad===========*/
ALTER TABLE oficina
ADD CONSTRAINT 
uq_oficina_cuidad
UNIQUE (ciudad);
...
PRIMARY KEY (pedido_id, numero_producto, numero_fb),
CONSTRAINT fk_detalle_pedido_pedido
FOREIGN KEY (pedido_id)
REFERENCES pedido (pedido_id),
CONSTRAINT fk_detalle_pedido_producto
FOREIGN KEY (numero_producto, numero_fb)
REFERENCES producto (numero_producto, numero_fb)
);
GO
...
/*============== CREAR LAS FOREIGN KEY DE CLIENTE CON REPRESENTANTE ============*/
